...
(function(a){
    a.fn.slideshow_buttontitle=function(p){
        ...
        if(B.find("ul").length==0||B.find("li").length==0){
            ...
            B.find("ul:first").children("li").children("a").children("img").css("width",q);
...
//      var k=c+"px";
		var k = "100%";
        var l="border: "+f+" solid "+" "+e+"px; width:"+k+"; padding:"+b+"px; background-color:"+g;
        a.attr("style",l)
        }
        function s_s_n(a,b,c){
        var d=a.children("li");
        var e="width: "+c+"; background-color:"+b+";";
        d.attr("style",e)
        }
